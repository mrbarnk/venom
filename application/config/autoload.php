...
*/
$autoload['libraries'] = array('pagination', 'session', 'form_validation', 'upload', 'email', 'table');
...
*/
$autoload['helper'] = array('html', 'form', 'url', 'string', 'file', 'text', 'typography', 'inflector');
